#ifndef _ProtoVM_TubeAmpSimulation1970s_h_
#define _ProtoVM_TubeAmpSimulation1970s_h_
...
// Class for tube-based amplifier simulation for 1970s era (American high-gain characteristics)
class TubeAmpSimulation1970s : public ElectricNodeBase {
public:
    typedef TubeAmpSimulation1970s CLASSNAME;

    TubeAmpSimulation1970s();
    virtual ~TubeAmpSimulation1970s();

    virtual bool Tick() override;
    virtual String GetClassName() const override { return "TubeAmpSimulation1970s"; }
    ...
    void SetHighGainMode(bool high_gain); // Whether to simulate high gain (master volume) setup
    ...
    bool GetHighGainMode() const { return high_gain_mode; }

private:
    // Amp parameters for 1970s American era (high-gain, master volume designs)
    double gain;           // Overall gain (high for 1970s high-gain sound)
    double bass;           // Bass control
    double mid;            // Mid control (often with mid-scooped sound common in 70s)
    ...
    bool high_gain_mode;         // Whether to simulate high-gain master volume setup
    ...
    // Tone stack simulation (classic high-gain style for 1970s)
    ...
    // Constants
    static constexpr int MAX_TUBES = 12;  // More tubes for high-gain circuits
    static constexpr double MIN_GAIN = 0.1;
    static constexpr double MAX_GAIN = 500.0;  // Very high gain for 1970s high-gain amps
    static constexpr double MIN_BASS = 0.0;
    static constexpr double MAX_BASS = 2.5;  // Extended range for high-gain tone
    static constexpr double MIN_MID = 0.0;
    static constexpr double MAX_MID = 2.5;  // Often scooped in 70s high-gain
    static constexpr double MIN_TREBLE = 0.0;
    static constexpr double MAX_TREBLE = 2.5;
    static constexpr double MIN_PRESENCE = 0.0;
    static constexpr double MAX_PRESENCE = 2.0;  // Extended range for high-gain presence
    static constexpr double MIN_RESONANCE = 0.0;
    static constexpr double MAX_RESONANCE = 2.0;  // Extended range for OT resonance
